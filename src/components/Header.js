            ...
            <div className="flex items-center justify-between px-10 py-5 border-b">
                <div className="flex gap-5 items-center">
                    ...
                    <span className="flex items-center gap-1">
                        ...
                        <span className="text-gray-500">Gandhinagar, Gujarat</span>
                    </span>
                </div>
